/*
 *	engine/core/ManagedObject.cpp generated by engine3 IDL compiler 0.55
 */
...
ManagedObjectServant::ManagedObjectServant() {
...
void ManagedObjectServant::_setStub(DistributedObjectStub* stub) {
	_this = (ManagedObject*) stub;
}

DistributedObjectStub* ManagedObjectServant::_getStub() {
	return _this;
}
