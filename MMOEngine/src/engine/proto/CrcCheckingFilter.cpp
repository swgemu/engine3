...
void CrcCheckingFilter::appendCRC(Packet* pack, uint16 crcLength) {
...
bool CrcCheckingFilter::testCRC(Packet* pack, uint16 crcLength) {
	char* pData = pack->getBuffer();
	int nLength = pack->size();
...
unsigned int CrcCheckingFilter::generateCrc(Packet* pack, int nLength) {
	char* pData = pack->getBuffer();
