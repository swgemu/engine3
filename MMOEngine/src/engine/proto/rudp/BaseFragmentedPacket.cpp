...
BaseFragmentedPacket::BaseFragmentedPacket() : RUDPPacket() {
	singlePacket = NULL;

	offset = 0;
}

BaseFragmentedPacket::BaseFragmentedPacket(RUDPPacket* pack) : RUDPPacket() {
	singlePacket = pack;
...
RUDPPacket* BaseFragmentedPacket::getFragment() {
	RUDPPacket* frag = new RUDPPacket();
