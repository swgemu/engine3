...
s,@PACKAGE_NAME@,|#_!!_#|engine3,g
s,@PACKAGE_TARNAME@,|#_!!_#|engine3,g
s,@PACKAGE_VERSION@,|#_!!_#|1.0,g
s,@PACKAGE_STRING@,|#_!!_#|engine3 1.0,g
...
s,@PACKAGE@,|#_!!_#|engine3,g
s,@VERSION@,|#_!!_#|1.0,g
s,@ACLOCAL@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOEngine/build/unix/config/missing --run aclocal-1.10,g
s,@AUTOCONF@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOEngine/build/unix/config/missing --run autoconf,g
s,@AUTOMAKE@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOEngine/build/unix/config/missing --run automake-1.10,g
s,@AUTOHEADER@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOEngine/build/unix/config/missing --run autoheader,g
s,@MAKEINFO@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOEngine/build/unix/config/missing --run makeinfo,g
s,@install_sh@,|#_!!_#|$(SHELL) /cygdrive/d/Programming/Projects/swgemu/MMOEngine/build/unix/config/install-sh,g
s,@STRIP@,|#_!!_#|,g
...
s,@AMTAR@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOEngine/build/unix/config/missing --run tar,g
